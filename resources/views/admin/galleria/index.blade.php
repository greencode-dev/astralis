...
@section('content')
    @include('admin.partials.index-header', ['description' => 'Gestisci le immagini della galleria dei corpi celesti', 'createRoute' => 'admin.galleria.create', 'createLabel' => 'Nuova Immagine'])

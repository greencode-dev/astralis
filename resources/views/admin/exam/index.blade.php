        ...
        <div class="rounded-xl p-6 bg-admin-card border border-admin-primary/10">
            ...
            <div class="space-y-3 text-sm">
                @foreach([
                    ...
                    ['label' => 'Migrations', 'path' => 'database/migrations/', 'count' => '21 file'],
                    ...
                    ['label' => 'Services', 'path' => 'app/Services/', 'count' => '3 service'],
        ...
        <div class="rounded-xl p-6 bg-admin-card border border-admin-primary/10">
            ...
            <div class="grid grid-cols-2 gap-3 text-sm">
                @foreach([
                    ...
                    ['key' => 'Admin', 'val' => 'Blade + Alpine.js (npm)'],
                    ['key' => 'Guest', 'val' => 'React 18 + Vite'],
                    ['key' => 'CSS', 'val' => 'Tailwind CSS'],
                    ['key' => 'Animazioni', 'val' => 'CSS transitions + requestAnimationFrame'],
        ...
        <div class="rounded-xl p-6 bg-admin-card border border-admin-primary/10">
            ...
            <div class="space-y-2 text-sm font-mono">
                @foreach([
                    ...
                    'app/Http/Requests/ → 13 FormRequest (Store/Update per entità)',

            ...
            <tbody>
                @forelse ($categorie as $categoria)
                    <tr style="border-bottom: 1px solid rgba(34, 211, 238, 0.05);" class="transition-colors duration-150" onmouseover="this.style.backgroundColor='rgba(34,211,238,0.03)';" onmouseout="this.style.backgroundColor='transparent';">
                        ...
                        <td class="py-3 px-4">
                            <a href="{{ route('admin.categorie.show', $categoria) }}" class="font-medium transition-colors duration-150" style="color: #F0F0FA;" onmouseover="this.style.color='#22D3EE';" onmouseout="this.style.color='#F0F0FA';">
                                {{ $categoria->nome }}
                            </a>
                        </td>
                        <td class="py-3 px-4">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="py-12 text-center">
                            ...
                            <a href="{{ route('admin.categorie.create') }}" class="text-sm font-medium transition-colors duration-150" style="color: #22D3EE;" onmouseover="this.style.color='#A855F7';" onmouseout="this.style.color='#22D3EE';">Crea la prima categoria</a>
                        </td>
                    </tr>
                @endforelse
            </tbody>

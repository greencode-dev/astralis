    ...
    <div class="max-w-4xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="rounded-xl p-6 md:col-span-1 flex flex-col items-center text-center bg-admin-card border border-admin-primary/10">
                ...
                @if ($categoria->colore)
                    @include('admin.partials.category-badge', ['color' => $categoria->colore, 'name' => $categoria->colore, 'size' => 'lg', 'withDot' => true])
                @endif
            ...
            <div class="rounded-xl p-6 md:col-span-2 bg-admin-card border border-admin-primary/10">
                ...
                @include('admin.partials.show-actions', ['editRoute' => route('admin.categorie.edit', $categoria), 'deleteRoute' => route('admin.categorie.destroy', $categoria), 'entityName' => $categoria->nome])
            </div>
        </div>

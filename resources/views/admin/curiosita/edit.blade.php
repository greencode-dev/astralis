...
@section('content')
    <div class="max-w-2xl">
        <a href="{{ route('admin.curiosita.index') }}" class="inline-flex items-center gap-2 text-sm mb-6 transition-colors duration-150 hover:text-[#22D3EE]" style="color: #9CA3AF;">

                ...
                @empty
                    <tr>
                        <td colspan="5" class="py-12 text-center">
                            ...
                            <a href="{{ route('admin.curiosita.create') }}" class="text-sm font-medium transition-colors duration-150" style="color: #22D3EE;" onmouseover="this.style.color='#A855F7';" onmouseout="this.style.color='#22D3EE';">Crea la prima curiosità</a>
                        </td>
                    </tr>
                @endforelse
            </tbody>

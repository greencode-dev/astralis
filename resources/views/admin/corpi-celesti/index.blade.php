                ...
                @empty
                    <tr>
                        <td colspan="6" class="py-12 text-center">
                            ...
                            <a href="{{ route('admin.corpi-celesti.create') }}" class="text-sm font-medium transition-colors duration-150" style="color: #22D3EE;" onmouseover="this.style.color='#A855F7';" onmouseout="this.style.color='#22D3EE';">Crea il primo corpo celeste</a>
                        </td>
                    </tr>
                @endforelse
            </tbody>

...
- [Setup nuovo PC → Guida all'installazione](documentazione.md#guida-allinstallazione-prima-configurazione)
- [Setup rientro → Guida al rientro](documentazione.md#guida-al-rientro-clone-su-altro-pc)
- [Setup skill OpenCode](documentazione.md#setup-opencode-skills)
- [Windows gotchas](documentazione.md#windows-git-bash--gotchas)
- [Task plan](todo.md)

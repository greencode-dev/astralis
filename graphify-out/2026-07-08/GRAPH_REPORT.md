...
## Corpus Check
- 227 files · ~66,210 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 854 nodes · 1224 edges · 167 communities (163 shown, 4 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 58 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d39698cf`
...
## Communities (167 total, 4 thin omitted)

### Community 0 - "User"
Cohesion: 0.05
Nodes (19): User, CategoriaPolicy, CuriositaPolicy, AuthServiceProvider, Authenticatable, BaseTestCase, HasFactory, Notifiable (+11 more)
...
Cohesion: 0.05
Nodes (37): CuriositaController, DashboardController, JsonResponse, MissioneController, Request, ConfirmablePasswordController, RedirectResponse, Request (+29 more)
...
Cohesion: 0.17
Nodes (3): CorpoCeleste, HasMany, CorpoCelestePolicy

### Community 50 - "NavLink.jsx"
Cohesion: 0.24
Nodes (4): FetchNasaCommand, CorpoCelesteObserver, NasaImageService, Command
...
## Knowledge Gaps
- **183 isolated node(s):** `$schema`, `name`, `type`, `description`, `keywords` (+178 more)
...
- **Why does `Controller` connect `Curiosita` to `CorpoCeleste`, `Missione`, `JsonResource`, `Palette Colori`, `LoginRequest`, `GalleriaCorpo`, `🪐 Astralis — Catalogo di Corpi Celesti`, `Edit.jsx`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `Missione`, `Curiosita`, `GalleriaCorpo`, `🪐 Astralis — Catalogo di Corpi Celesti`, `Modal.jsx`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `CorpoCeleste` connect `Modal.jsx` to `AppServiceProvider.php`, `CorpoCeleste`, `JsonResource`, `Palette Colori`, `Curiosita`, `GalleriaCorpo`, `🪐 Astralis — Catalogo di Corpi Celesti`, `NavLink.jsx`, `Edit.jsx`?**
